...
from .. import storage, gemini_util
...
class BaseHronirAgent(ABC):
    ...
    def __init__(self, config: AgentConfig, system_config: Optional[SystemConfig] = None):
        self.config = config
    ...
    def get_narrative_context(self, position: int, predecessor_uuid: Optional[str] = None) -> str:
