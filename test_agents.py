...
def test_basic_agent_functionality():
    ...
    try:
        ...
        print(f"✅ Chapter generated successfully!")
        ...
        print(f"✅ Competitive chapter generated!")
...
def show_system_status():
    ...
    try:
        ...
        print(f"❌ Google Generative AI: Not available")
    
    try:
        import crewai
        print(f"✅ CrewAI: Available (v{crewai.__version__})")
    except ImportError:
        print(f"⚠️  CrewAI: Not available (optional)")
    ...
    try:
        ...
        print(f"❌ DuckDB: Not available")
    
    # Check agent modules
    try:
        from hronir_encyclopedia.agents.chapter_writer import ChapterWriterAgent
        print(f"✅ Chapter Writer Agent: Available")
    except ImportError:
        print(f"❌ Chapter Writer Agent: Not available")
    
    try:
        from hronir_encyclopedia.agents.judge import JudgeAgent
        print(f"✅ Judge Agent: Available")
    except ImportError:
        print(f"❌ Judge Agent: Not available")
